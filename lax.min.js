...
!(function () {
  var lax = (function () {
    function intrp(t, a) {
      ...
      var n = t[e][0],
        o = void 0 === t[e - 1] ? n : t[e - 1][0],
        r = t[e][1],
        l = void 0 === t[e - 1] ? r : t[e - 1][1];
      return Math.min(Math.max((a - o) / (n - o), 0), 1) * (r - l) + l;
    }
    for (
      var lax = {
          elements: [],
    ...
    return (
      ...
      (lax.removeElement = function (t) {
        var a = this.elements.findIndex(function (a) {
          return (a.el = t);
        });
      ...
      (lax.addElement = function (el) {
        ...
        presetNames &&
          (presetNames.split(" ").forEach(function (t) {
            ...
            if (e) {
              var n = e(a[1]);
              for (var o in n) el.setAttribute(o, n[o]);
      ...
      (lax.updateElement = function (t) {
        ...
        for (var o in t.transforms) {
          var r = t.transforms[o],
            l = transforms[o],
            c = intrp(r, e);
          if (!l) return void console.error("lax: " + o + " is not supported");
          l(n, c);
        }
        for (var i in n)
